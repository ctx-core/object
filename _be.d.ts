 ...
 */
export declare function _be<O extends unknown>(key: string | symbol, _val: (ctx?: object, key?: (string | symbol), opts?: _be_opts_type) => (void | O)): (ctx?: object, opts?: _be_opts_type) => O;
