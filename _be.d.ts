 ...
 */
export declare function _be<C extends object = object, O extends unknown = unknown>(key: string | symbol, _val: (ctx: C, key: (string | symbol), opts?: _be_opts_type) => (void | O)): be_type<C, O>;
export declare type Be<O> = (ctx: object, opts?: _be_opts_type) => O;
export interface _be_opts_type {
    force?: boolean;
}
export declare type B<O> = Be<O>;
export declare type be_type<C extends object = object, O extends unknown = unknown> = (ctx: C, opts?: _be_opts_type) => O;
export { _be as _b, };
