 ...
 */
export function pick<I extends object = object>(obj:I, ...key_a1:string[]) {
	let memo = {} as I
...
export function maybe_pick<I extends object = object>(obj:I, ...key_a1:string[]): maybe_undefined<I> {
	if (!obj) return
