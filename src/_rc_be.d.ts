 ...
 */
export declare function _rc_be</*@formatter:on*/ Ctx extends object = Record<string, unknown>, Key extends keyof Ctx = keyof Ctx, Out extends NonNullable<unknown> = NonNullable<Ctx[Key]>>(key: Key, _val: (this: _val_this_T, ctx: Ctx, key: Key, opts?: _be_opts_T) => Out): RcBe<Ctx, Key, Out>;
