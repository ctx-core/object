 ...
 */
export declare function map_obj_andand<In extends unknown = unknown, Out extends unknown = unknown>(obj:Record<string, In>, ...key_a:andand_key_T<In>[]):Record<string, Out|nullish>
