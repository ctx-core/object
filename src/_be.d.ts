 ...
 */
export declare function _be</*@formatter:on*/ Ctx extends object = Record<string, unknown>, Key extends keyof Ctx = keyof Ctx, Out extends NonNullable<unknown> = NonNullable<Ctx[Key]>>(key: Key, _val: (ctx: Ctx, key: Key, opts?: _be_opts_T) => (void | Out)): Be<Ctx, Key, Out>;
